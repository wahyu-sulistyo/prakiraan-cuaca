...
document.body.style.backgroundImage = 'url(img/tnm.png)'

searchButton.addEventListener('click', function() {

    fetch("https://api.openweathermap.org/data/2.5/weather?q="+inputKeyword.value+"&appid=2df2322bdd9639635b377b277958897d&units=metric")
